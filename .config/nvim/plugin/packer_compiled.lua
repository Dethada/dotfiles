...
_G.packer_plugins = {
  ...
  ["lean.nvim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/lean.nvim",
  ...
  ["nvim-neoclip.lua"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/nvim-neoclip.lua",
  ...
  ["vim-better-whitespace"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-better-whitespace",
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-hexokinase",
